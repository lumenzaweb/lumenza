...
const allSubProducts = {
    ...
    details: [
        ...
        { img: "https://i.pinimg.com/736x/6e/eb/4a/6eeb4a72e-94f1adc55416a2479e9-e2c3.jpg", title: "LM - 3102", finishes: ["Satin Finish", "B.Antik Finish", "Z.Black Finish", "BL Satin Finish"] },
        ...
        { img: "https://i.pinimg.com/736x/ba/91/34/ba913428bff40c7cc2e0-e90d7b59c702.jpg", title: "LM - 3104", finishes: ["Satin + CP Finish", "BL + GL Finish", "Antik + GL Finish", "BL Satin + BL Nickel Finish"] },
        { img: "https://i.pinimg.com/736x/c2/b8/6d/c2b86d17e-5d38a-3584a635fd7af9ce21.jpg", title: "LM - 3105", finishes: ["Satin + CP Finish", "Antik + BL Finish", "PVD RG + BL Finish", "PVD GL + BL Finish"] },
                    ...
                    {product.details.map((item, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 flex flex-col text-center transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <div className="p-4 flex-grow flex flex-col items-center justify-center">
                                ...
                                <ul className="list-disc list-outside text-black text-sm">
