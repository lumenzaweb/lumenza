...
const allSubProducts = {
    ...
    "Profile handle": {
        ...
        features: [
            ...
            "Hygic Surface: Their simple shape makes cleaning easy, minimizing dust and grime accumulation.",
            ...
            <main className="min-h-screen bg-gray-50 text-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                    ...
                    <section className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                        ...
                        <div className="flex flex-col items-center w-full lg:w-2/5 lg:sticky top-20 self-start">
