...
const allSubProducts = {
  ...
  "Door Closer": {
    name: "Door Closer",
    description: "LUMENZA provides High-quality door closers with smooth operation and robust design. Available in multiple finishes.",
    images: [
   ...
   "Wire basket": {
    name: "Wire basket",
    description: "LUMENZA wire basket and a pullout are essential kitchen accessories designed for organized storage and efficient space utilization. Both are made of durable wire—often chrome-plated—for strength and corrosion resistance, providing modern convenience and aesthetic appeal.",
    images: [
  ...
  "Profile handle": {
    name: "Profile handle",
    description: "LUMENZA profile handle is typically made from materials like aluminum, stainless steel, or zinc alloy. Designed to be fitted along the edge of cabinet fronts, it allows for easy grip and operation while maintaining a streamlined, unobtrusive appearance.",
    images: [
  ...
  "Cabinet handle": {
    name: "Cabinet handle",
    description: "Lumenza provides a diverse range of cabinet handles that suit various décor styles, from sleek minimalist bars to more decorative and geometric designs. These handles are crafted to provide a sturdy grip and elevate the visual appeal of cabinets while ensuring easy operation.",
    images: [
  ...
  "Wardrobe Lock": {
    name: "Wardrobe Lock",
    description: "Lumenza sources high-quality wardrobe locks known for their sturdy construction, smooth locking mechanism, and aesthetic appeal. These locks are designed to fit various wardrobe types and ensure enhanced security alongside elegant finishes. These locks are widely used in office furniture, residential storage cabinets, and retail fixtures to prevent unauthorized access.",
    images: [
      "https://i.pinimg.com/736x/1f/b9/83/1fb983f1b894c1714751c60d47f49c82.jpg",
    ],
    features: [
  ...
  "Knob": {
    name: "Knob",
    description: "Lumenza company recognized for its premium, design-forward cabinet knobs that combine functionality with modern aesthetics. Our knob collection offers a refined touch for contemporary and classic interiors, ensuring quality and versatility for every space.",
    images: [
  ...
  "Silicone": {
    name: "Silicone",
    description: "GP300 is one part acetic cure silicone sealant. A strong, fast curing, general purpose & is unaffected by rain, sunlight, snow etc. It is formulated with years if experience on a wide range of applications. It is a silicone sealant with high UV & water resistance.",
    images: [
...
const ProductSubDetailPage = () => {
  ...
  const product = allSubProducts[subProductSlug];
  const [currentImageIdx, setCurrentImageIdx] = useState(0);

  // Variant Gallery for Secure types
  if (
    ["Secure Lite", "Secure X", "Secure ECO", "Door Closer", "Wire basket", "Sheet basket", "Profile handle", "Cabinet handle", "Wardrobe Lock", "Knob", "Silicone"].includes(subProductSlug) &&
    product
  ) {
    return (
      <main className="py-40 px-20 min-h-screen bg-gray-50 p-6 flex flex-col">
        <button
          onClick={() => navigate(-1)}
          className="self-start mb-6 px-5 py-3 bg-red-800 text-white rounded-lg hover:bg-black transition shadow-md"
        >
          ← Back
        </button>
        <section className="flex flex-1 gap-8 max-w-full overflow-hidden">
          {/* Image Gallery Section */}
          <div className="flex flex-col items-center w-1/3 max-w-xs">
          ...
          <div className="flex-1 max-w-3xl flex flex-col overflow-auto">
            ...
            <>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">Finishes</h2>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-3 text-gray-600 list-disc list-inside">
            ...
            {product.productDetails && product.productDetails.length > 0 && (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 gap-3 max-h-96 overflow-y-auto">
        ...
        <section className="mt-16 max-w-4xl mx-auto p-6 bg-red-100 border-2 border-red-700 rounded-lg shadow-lg text-center">
          <h2 className="text-2xl font-semibold mb-4 text-red-900">Download Our Product Catalog</h2>
  ...
  // Side-by-side grid for Mortise (or similar products with details array)
  if (product && product.details && product.details.length > 0) {
    return (
      <main className="py-45 px-15 min-h-screen bg-gray-50 flex flex-col">
        ...
        {/* PDF Download Box - place it here */}
  <section className="mt-16 max-w-4xl mx-auto p-6 bg-red-100 border-2 border-red-700 rounded-lg shadow-lg text-center">
    <h2 className="text-2xl font-semibold mb-4 text-red-900">Download Our Product Catalog</h2>
    <p className="mb-6 text-red-800">
      Get all product details and specifications in one handy PDF file.
