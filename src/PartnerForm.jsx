...
const PartnerForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const submissionData = {
        ...
        formType: "Partner" // IMPORTANT: Define form type for backend routing
    };
                ...
                <motion.div key="step1" variants={stepVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      {errors.name && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.name}</p>}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      {errors.firmName && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.firmName}</p>}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      {errors.contact && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.contact}</p>}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      {errors.email && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.email}</p>}
                    </div>
                  </div>
                </motion.div>
              )}
                ...
                <motion.div key="step2" variants={stepVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
                   ...
                   <div className="space-y-4">
                     ...
                     <div className="relative">
                        ...
                        {errors.address && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.address}</p>}
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       <div className="relative">
                         ...
                         {errors.country && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.country}</p>}
                       </div>
                       <div className="relative">
                         ...
                         {errors.state && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.state}</p>}
                       </div>
                     </div>
                     ...
                     <div className="relative">
                        ...
                        {errors.city && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.city}</p>}
                     </div>
                     ...
                     <div className="relative">
                        ...
                        {errors.category && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.category}</p>}
                     </div>
                     ...
                     <div className="relative">
                        ...
                        {errors.investment && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.investment}</p>}
                     </div>
                   </div>
                </motion.div>
              )}
              {step === 3 && (
                <motion.div key="step3" variants={stepVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    {errors.message && <p className="text-red-400 text-xs mt-1 px-1 absolute -bottom-5 left-0">{errors.message}</p>}
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
