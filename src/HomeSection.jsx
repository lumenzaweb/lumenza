...
const HomeSection = () => {
  ...
  useEffect(() => {
    ...
    }, 3000); // This duration should match the progress bar's transition duration
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <AnimatePresence>
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 1.5, ease: [0.6, 0.05, 0.01, 0.9] }} // Smoother ease
          />
        </AnimatePresence>
      </div>
      ...
      {/* NEW Slider Progress Bar Navigation */}
      <div
      ...
      >
        {images.map((_, index) => (
          ...
          >
            {/* The progress fill, which only animates for the active slide */}
            {current === index && (
              <motion.div
