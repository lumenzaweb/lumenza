...
const SocialBar = () => (
  <section className="bg-white py-6 px-4 sm:px-6 border-t border-gray-200">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      {/* Left Column (Placeholder on Desktop) */}
      {/* This empty div takes up space on desktop to push the middle content to the center. */}
      ...
      <div className="flex flex-col items-center text-center gap-4 order-first md:order-none">
