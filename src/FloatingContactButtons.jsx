...
const ActionButton = ({ href, title, icon, bgColor }) => (
  ...
  >
    ...
    {/* Label is on the RIGHT and is HIDDEN on mobile (md:block) */}
    <span className="ml-4 text-sm font-medium text-gray-700 bg-white px-4 py-2 rounded-full shadow-sm whitespace-nowrap hidden md:block">
      {title}
    </span>
  </motion.a>
);
