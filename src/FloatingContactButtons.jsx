...
const ActionButton = ({ href, title, icon, bgColor }) => (
  <motion.a
    ...
    className="flex items-center justify-end w-auto" // justify-end aligns content to the right
    variants={{
      open: { opacity: 1, y: 0, x: 0 },
      closed: { opacity: 0, y: 10, x: 10 },
    }}
  >
...
const FloatingContactButtons = () => {
  ...
  const contactLinks = [
    { href: "mailto:support@lumenza.co.in", title: "Email Us", icon: ( <svg className={iconStyles} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> ), bgColor: "bg-gray-800" },
  ...
  ].sort((a, b) => a.title.localeCompare(b.title)); // Sort alphabetically for consistent order
